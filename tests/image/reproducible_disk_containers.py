...
class DiskImageWithContainerdIsByteIdenticalAcrossTwoBuilds(ReproducibleDiskImage, avocado.Test):
    """
    :avocado: tags=full,container
    """
    timeout = 3600
    FILENAME = "reproducible-disk-containerd.img"

    def specification(self):
        where = os.path.join(self.workdir, "reproducible-disk-containerd.yml")
        with open(where, "w") as f:
            f.write(
                "distribution:\n"
                "    release: bookworm\n"
