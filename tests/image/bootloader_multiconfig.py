...
# One disk, two independently-packaged operating systems, each with a
# real kernel and grub -- checks the resulting grub.cfg has one
# seine-authored menuentry per group, pointing at that group's own
# kernel/initrd and root PARTUUID. Static content only: nothing here
# actually boots either entry.
